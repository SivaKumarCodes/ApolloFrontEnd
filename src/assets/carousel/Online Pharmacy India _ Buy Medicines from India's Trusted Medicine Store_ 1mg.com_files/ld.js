!(function () {
          ...
          clearTimeout(n),
            t
              ? (r.logger('GDPR CMP ping returned'),
                !0 !== e.cmpLoaded &&
                  o(i, 'GDPR ping returned cmpLoaded which is not true'),
                r.logger('GDPR ping returned cmpLoaded which is true'))
              : o(i, 'Error sending ping to GDPR CMP');
        });
      }, t);
    }),
      ...
      var i = this,
        ...
        a = this.pingWithTimeout(
          ...
          function () {
            (o = !0),
              i.logger(
                'Timeout: Unable to ping GDPR API after ' + i.pingTimeout + 'ms'
              ),
              n(void 0);
          }
        );
      this.executeCommand(e, t, function (e, t) {
        clearTimeout(a),
          o ||
            (clearTimeout(r),
            t
              ? (i.logger('GDPR consent retrieved'), i.processConsentData(e, n))
              : (i.logger('Error retrieving GDPR consent data from CMP'),
                n(void 0)));
      });
    }),
      ...
      if (!this.hasCallerFunctionInFrame()) {
        ...
        (this.currentWindow.__cmp = function (e, t, n) {
          ...
          var i = Math.random().toString(10),
            o = { __cmpCall: { command: e, parameter: t, callId: i } };
  ...
  var c =
      ...
      return window.setTimeout(function () {
        ...
        r.executeCommand('ping', 2, function (e) {
          clearTimeout(t),
            ...
            'error' === e.cmpStatus
              ? o(n, 'Error status on ping to TCFv2 CMP')
              : !0 !== e.cmpLoaded
              ? o(n, 'TCFv2 ping returned cmpLoaded = false')
    ...
    (t.prototype.processResponseData = function (e, t) {
      ...
      if (e) {
        var i = {};
        void 0 !== e.tcString && (i.consentData = e.tcString),
          void 0 !== e.gdprApplies && (i.gdprApplies = !!e.gdprApplies),
          (i.version = e.tcfPolicyVersion ? e.tcfPolicyVersion : 2),
          (i.purposes =
            null === (n = null == e ? void 0 : e.purpose) || void 0 === n
              ? void 0
              : n.consents),
          t(i);
      } else
      ...
      if (!this.hasCallerFunctionInFrame()) {
        ...
        (this.currentWindow.__tcfapi = function (e, t, n, i) {
          ...
          var o = Math.random().toString(10),
            r = {
              __tcfapiCall: { command: e, version: t, parameter: i, callId: o },
            };
    ...
    (n.prototype.retrieveConsent = function (n) {
      ...
      this.executeCommand('getUSPData', 1, function (e, t) {
        o ||
          (clearTimeout(r),
          t
            ? (i.logger('CCPA consent retrieved'), i.processResponseData(e, n))
            : (i.logger('Error retrieving CCPA consent data from CMP'),
              n(void 0)));
      });
    }),
    ...
    (n.prototype.executeCommand = function (e, t, n) {
      ...
      if (!this.hasCallerFunctionInWindow()) {
        ...
        (this.currentWindow.__uspapi = function (e, t, n) {
          ...
          var i = Math.random().toString(10),
            o = { __uspapiCall: { command: e, parameter: t, callId: i } };
  ...
  function h() {}
  var f =
    ((m.prototype.getProvider = function () {
      return this.tcfv2ConsentProvider.readyToRetrieve()
        ? this.tcfv2ConsentProvider
        : this.ccpaConsentProvider.readyToRetrieve()
        ? this.ccpaConsentProvider
  ...
  function m(e, t, n, i) {
    void 0 === t && (t = 1e4),
      void 0 === n && (n = 50),
      void 0 === i && (i = 1e3);
    var o = { tcfTimeout: t, tcfPingTimeout: n, tcfPingDelay: i },
      r = { uspApiTimeout: t };
    (this.tcfv1ConsentProvider = new a(e, o, A.info)),
      (this.tcfv2ConsentProvider = new c(e, o, A.info)),
      (this.ccpaConsentProvider = new l(e, r, A.info));
  }
  function E(e) {
  ...
  var g =
    ((v.prototype.catchAndStoreException = function (e, t) {
      try {
  ...
  var w,
    ...
    N =
      ...
      (k.getHighestAccessibleUrl = function (e) {
        var t,
          n = k.getHighestAccessibleWindow(e),
          i = n.topFrame;
        if (n.err)
          try {
            try {
      ...
      (k.getPreviousUrl = function (e) {
        var t,
          n,
          i = k.getHighestAccessibleWindow(e),
          o = i.topFrame,
          r = '';
        if (
          (i.err ||
            ...
            document.onload = document.onreadystatechange = function (e) {
              r instanceof Function && r(document, e),
                t ||
                  ...
                  (o instanceof Function && o(document, e), (t = !0), i());
            };
          }
        }
      }),
  ...
  function U(e, t) {
    for (var n = 0, i = e; n < i.length; n++) {
      ...
      if (
        o.event === t.event &&
        W(t.account, o.account) &&
        o.hash_method === t.hash_method
      )
        return void (
          void 0 !== t.email &&
          (o.email = y(
            o.email instanceof Array || void 0 === o.email
              ? o.email
              : [o.email],
  ...
  function G(e, t) {
    for (var n = 0, i = e; n < i.length; n++) {
      var o = i[n];
      if (
        (o.event === t.event && void 0 === t.account && void 0 === o.account) ||
        W(t.account, o.account)
      ) {
        for (var r in t)
          t.hasOwnProperty(r) && 'account' !== r && (o[r] = t[r]);
  ...
  ((C = w = w || {})[(C.None = 0)] = 'None'),
    (C[(C.Cookie = 1)] = 'Cookie'),
    (C[(C.LocalStorage = 2)] = 'LocalStorage');
  var b =
    ((P.checkLocalStorageIsWritable = function () {
      try {
    ...
    (P.prototype.setOnMainDomainWithExpiration = function (e, t) {
      ...
      for (
        ...
        var s =
            'domain=.' + (r = o.slice(o.length - a - 1, o.length).join('.')),
  ...
  function P(e, t) {
    (this.cookieValue = null),
      ...
      (this.cookieOrigin = w.None),
      (this.useLocalStorage = P.checkLocalStorageIsWritable());
  }
  var q =
    ((T.prototype.fillQueryStringParams = function (e, t) {
      ...
      n && e.push('fpid=' + n),
        ...
        void 0 !==
          new b('cto_clc', this.readonlyCookieRetentionTime).getValue() &&
          e.push('clc=1');
    }),
    ...
    (T.prototype.checkCookies = function (e) {
      ...
      if (e.callbacks) {
        for (
          var n = 0,
            i = 'string' == typeof e.callbacks ? [e.callbacks] : e.callbacks;
          n < i.length;
          n++
        ) {
          var o = i[n],
    ...
    (T.prototype.setCanWriteCookie = function () {
      null === this.axidCookie.cookieValue &&
      null === this.pxsigCookie.cookieValue
        ? (this.canWriteCookie = b.checkCookiesAreWritable())
        : (this.canWriteCookie = !0);
    }),
  ...
  function T(e, t, n, i) {
    (this.readonlyCookieRetentionTime = 0),
      ...
      (this.axidCookie = new b('cto_axid', this.readonlyCookieRetentionTime)),
      (this.optoutCookie = new b('cto_optout', this.optoutCookieRetentionTime)),
      (this.pxsigCookie = new b('cto_pxsig', this.readonlyCookieRetentionTime)),
      (this.secureIdCookie = new b(
        'cto_sid',
        this.identificationCookieRetentionTime
      )),
      (this.bundleCookie = new b(
        'cto_bundle',
        this.identificationCookieRetentionTime
      )),
      (this.ifaCookie = new b(
        'id_controller_ifa',
        this.identificationCookieRetentionTime
      )),
  ...
  var H =
    ((_.prototype.createIframe = function (e, t, n, i, o) {
          ...
          (E(n)
            ? (void 0 !== n.gdprApplies &&
              ...
              void 0 !== n.consentData &&
                (d += '&gdpr_consent=' + n.consentData))
            : F(n) &&
              void 0 !== n.uspString &&
              (d += '&us_privacy=' + n.uspString)),
        (d += '#' + JSON.stringify(l)),
        (r.src = d),
  ...
  function _(e) {
    (this.forceSyncFrame = !1),
      (this.gumSyncFrameOrigin = 'https://' + s('gumDomain', 'gum.criteo.com')),
      ...
      (this.waitingForSyncframe = e.hasItp || s('waitForGum', !0));
  }
  var z = new RegExp(
      /^Mozilla\/5\.0 \([^)]+\) AppleWebKit\/[^ ]+ \(KHTML, like Gecko\) Version\/([^ ]+)( Mobile\/[^ ]+)? Safari\/[^ ]+$/i
    ),
    Y =
      ((I.prototype.canRetrieveMetrics = function () {
  ...
  var J =
    ((S.prototype.trySetPageId = function (e, t) {
      this.isCbsEnabled &&
    ...
    (S.prototype.tryRunActionAfterAdBlockDetectionOrImmediate = function (
      t,
      e
    ) {
      var n = this,
  ...
  function Q(e, t, n, i, o) {
    if (
      ((function () {
        ...
        var t = 'enable' === e[1],
          n = Number(e[3]);
        new b('criteoTagDebugMode', t ? 864e5 : 0).setValueWithNoDomain(
      ...
      return (
        (window.onerror = (function (r) {
          return function (e, t, n, i) {
            var o = { column: i, lineNumber: n, message: e, url: t };
            return (
              a.pushError(o),
              !(!r || 'function' != typeof r) && r.apply(window, [e, t, n, i])
            );
          };
        })(window.onerror)),
        a
  ...
  var D,
    X =
      ...
      (Z.prototype.registerTrigger = function (e) {
        if (this.isFeatureAllowed('attribution-reporting')) {
          ...
          t.setAttribute('style', 'display:none;'),
            ...
            t.setAttribute(
              'attributionsrc',
              Z.ATTRIBUTION_TRIGGER_URL_PREFIX + '?' + e
            );
          var n = document.getElementsByTagName('script')[0];
      ...
      (Z.ATTRIBUTION_TRIGGER_URL_PREFIX =
  ...
  function Z(e, t) {
    (this.document = e),
      ...
      this.isChrome() &&
        (this.addTrialToken(Z.CRITEO_NET_TOKEN),
        this.addTrialToken(Z.CRITEO_COM_TOKEN));
  }
    ...
    (window.criteo_q = (function () {
      ...
      function l(e, t, n, i, o, r, a, s) {
        e.waitingForSyncframe &&
          ((e.waitingForSyncframe = !1), c(e, t, n, i, o, r, a, s));
      }
      function i(t, n, i, o, r, a, s, c, e) {
        if (t.shouldInjectSyncframe()) {
          var u = t.createIframe(
            o,
            a.tagVersion,
            e,
            P,
            a.privateModeDetectionEnabled
          );
          window.addEventListener &&
            (P.addProtectedEventListener(
              window,
              'message',
              function (e) {
                !(function (e, t, n, i, o, r, a, s, c) {
                  ...
                  if (
                    !(
                      (u && c.origin == e.gumSyncFrameOrigin) ||
                  ...
                  c.stopPropagation(),
                    i.checkCookies(u),
                    e.waitingForSyncframe && l(e, t, n, i, o, r, a, s);
                })(t, n, i, o, r, a, s, c, e);
              },
              !0
            ),
            S(n, c, s, { event: 'appendtag', element: u }));
        }
      }
      function r(e, t) {
        !(function (e) {
      ...
      function c(e, t, n, i, o, r, a, s) {
        for (var c = [], u = t.queue, l = 0; l < u.length; ++l) {
          ...
          if (d instanceof Function) u.splice(l + 1, 0, d());
            ...
            switch (h(t, n, i, o, r, a, s, d, l, u, c)) {
              case 0:
                c.push(d);
                break;
              case -1:
        ...
        a.afterEval instanceof Function && a.afterEval(),
          (t.queue = c || []),
          s.manualFlush ||
            (s.noPartialFlush && 0 !== t.queue.length) ||
            e.waitingForSyncframe ||
            b(t, n, i, o, r, a, s, 0 !== t.queue.length);
      }
      function I(e, t, n) {
        n.hasOwnProperty('account') || (n.account = t.accounts);
        var i = e.handlerResponseType;
        n.hasOwnProperty('type') && ((i = n.type), delete n.type),
          x(n.account, t.disingScheduled),
          'sequential' === i && (n.dc = !0);
      }
      function S(e, t, n, i) {
        var o = R(e, i);
      ...
      function k(e, t, n, i) {
        if (
          ...
          i.isImgUrl
            ...
            o.setAttribute('src', i.url),
            (i.element = o);
        }
        if (
          (n.beforeAppend instanceof Function &&
            (i.element = n.beforeAppend(i.element)),
          V(i),
      ...
      function R(e, t) {
        return !e.domReady && t.requiresDOM && 'no' !== t.requiresDOM
          ...
          : (delete t.requiresDOM,
            t.event
              ? (t.account && x(t.account, e.accounts),
      ...
      function h(e, t, n, i, o, r, a, s, c, u, l) {
        ...
        switch (s.event) {
          ...
          case 'setgoogleadvertisingid':
            return (
              (n.gaid = s.gaid),
              B(o.extraData, e.actions, { event: 'setdata', site_type: 'aa' })
            );
          case 'setappleadvertisingid':
            return (
              (n.idfa = s.idfa),
              B(o.extraData, e.actions, { event: 'setdata', site_type: 'aios' })
            );
          case 'setemail':
          case 'sethashedemail':
          case 'ceh':
          ...
          case 'setidentity':
            if (s.hasOwnProperty('identity')) {
              ...
              if (0 < (m = M(m)).length)
                return (s.identity = m), e.actions.push(V(s)), 1;
            }
            return 0;
          case 'setsitetype':
            var g = 'd';
            return (
              ('mobile' !== s.type && 'm' !== s.type) || (g = 'm'),
              ('tablet' !== s.type && 't' !== s.type) || (g = 't'),
              (s.event = 'setdata'),
              delete s.type,
              (s.site_type = g),
              B(o.extraData, e.actions, s)
          ...
          case 'flushevents':
            return (
              b(e, t, n, i, o, r, a, c !== u.length - 1 || 0 !== l.length), 1
            );
          case 'setaccount':
        ...
        if (
          ...
          if (!a.manualDising && (!s || a.partialDis)) {
            ...
            0 < g.length &&
              ...
              })(o, n, { event: 'callDising', account: g });
          }
          var C = !1,
            k = (function (e, t, n, i, o) {
              ...
              for (var l = 0; l < r.length; ++l) {
                ...
                d.account &&
                  W(
                    null === o.account ? void 0 : o.account,
                    null === d.account ? void 0 : d.account
                  ) &&
                  delete d.account,
                  a.push('p' + l + '=' + D(i, d, []));
              }
              n.fillQueryStringParams(a, o),
                null !== o.partnerPayload &&
                  a.push('pp=' + D(i, o.partnerPayload, []));
              ...
              return (
                ...
                K(N.getPreviousUrl(window), a, o.fullUrlMaxLength, 'pu', 'pul'),
                a.push(
                  'dtycbr=' +
                    (function () {
          ...
          var b = function () {
            if (!C) {
              ...
              'function' == typeof r.onUrlGenerated
                ? r.onUrlGenerated(t.url)
                : 'beacon' === o.requestType && navigator.sendBeacon
                ? navigator.sendBeacon(t.url)
                : S(n, a, r, t),
                A.info('DIS call triggered', t.url, k),
                (n.eventSent = !0),
                T.registerTrigger(e),
                a.disOnce || (n.disingScheduled = []);
            }
          };
          _(function (e) {
            e &&
                  ...
                  return (
                    E(e)
                      ? (void 0 !== e.gdprApplies &&
                          t.push('gra=' + (e.gdprApplies ? 1 : 0)),
                        void 0 !== e.consentData &&
                          t.push('grs=' + e.consentData),
                        void 0 !== e.version && t.push('grv=' + e.version))
                      : F(e) &&
                        (void 0 !== e.uspString && t.push('cs=' + e.uspString),
                        void 0 !== e.version && t.push('cv=' + e.version)),
                    t
                  );
                })(e)
              ),
              i.tryRunActionAfterAdBlockDetectionOrImmediate(b, function (e) {
          ...
          for (var l in t)
            if (t.hasOwnProperty(l)) {
              ...
              u.push(
                ...
                void 0,
                (r = d.join('.')),
                (i.properties[r] ? i.properties[r] : o) + '=' + D(e, t[l], d))
              );
            }
          a += u.join('&');
        } else
          1 === n.length && 'event' === n[0]
            ? (a += e.events[t.toLowerCase()] ? e.events[t.toLowerCase()] : t)
            : (a += t);
      ...
      return P.catchAndStoreException(function () {
        return (
          ...
          N.onBodyReady(P, function () {
            y.hooks.onInitialized instanceof Function
              ? ((v.app.bodyReady = y.hooks.onInitialized()),
                A.warn(
          ...
          N.onDocumentReady(P, function () {
            y.hooks.onDOMReady instanceof Function
              ? ((v.app.domReady = y.hooks.onDOMReady()),
                A.warn(
          ...
          })(y.trackingCallData.extraData),
          s('visitEventEnabled', !1) &&
            (function (e, t) {
              function n() {
                t.eventSent ||
      ...
      $.adBlockDetector,
      (window.criteo_q.adBlockDetector = $.adBlockDetector),
      (D = window.criteo_q).push.apply(D, $);
  }
})();
