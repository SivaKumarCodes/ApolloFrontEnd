  ...
  return (function (t) {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e) {
        var n,
          ...
          w = t.stat,
          k = t.proto,
          I = S ? r : w ? r[b] : (r[b] || {}).prototype,
          E = S ? c : c[b] || l(c, b, {})[b],
          P = E.prototype;
        for (v in e)
          (i =
            !(n = u(S ? v : b + (w ? '.' : '#') + v, t.forced)) &&
            I &&
            p(I, v)),
            (y = E[v]),
            i && (m = t.dontCallGetSet ? (x = a(I, v)) && x.value : I[v]),
            (g = i && m ? m : e[v]),
            (i && typeof y == typeof g) ||
              ((_ =
                t.bind && i
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, c) {
        if (t) {
          ...
          s(f, u) || i(f, u, { configurable: !0, value: e }),
            c && !r && o(f, 'toString', a);
        }
      };
    },
    ...
    function (t, e, n) {
      ...
      t.exports = u(
        ...
        'Array',
        function (t, e) {
          p(this, { type: 'Array Iterator', target: r(t), index: 0, kind: e });
        },
        function () {
          var t = h(this),
            e = t.target,
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n) {
        ...
        if (I) g = t.iterator;
          ...
          if (a(y)) {
            for (m = 0, _ = u(t); _ > m; m++)
              if ((x = T(t[m])) && c(v, x)) return x;
            return new d(!1);
          }
          g = f(t, y);
        }
        for (b = I ? t.next : g.next; !(S = i(b, g)).done; ) {
          try {
            x = T(S.value);
          } catch (t) {
            p(g, 'throw', t);
          ...
          return function (d, v, g, y) {
            for (
              var m,
                ...
                k = 0,
                I = y || u,
                E = e ? I(d, w) : n || p ? I(d, 0) : void 0;
              w > k;
              k++
            )
              if ((h || k in b) && ((_ = S((m = b[k]), k, x)), t))
                if (e) E[k] = _;
                else if (_)
                  switch (t) {
                    case 3:
    ...
    function (t, e, n) {
      var r = n(133),
        i = n(114).concat('length', 'prototype');
      e.f =
    ...
    function (t, e, n) {
      var r = n(1),
        ...
        P = function (t, e, n) {
          var r = y(n, e - 1),
            i = y(n, e + 1);
          return (g(S, t) && !g(w, i)) || (g(w, t) && !g(S, r))
            ? '\\u' + x(m(t, 0), 16)
            : t;
        };
      v &&
        r(
          { target: 'JSON', stat: !0, arity: 3, forced: k || I },
          {
            stringify: function (t, e, n) {
              var r = h(arguments),
                i = o(k ? E : v, null, r);
              return I && 'string' == typeof i ? _(i, b, P) : i;
            },
          }
        );
    },
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, s, d, g, w) {
        ...
        var k,
          ...
          C = !1,
          T = t.prototype,
          O = T[b] || T['@@iterator'] || (d && T[d]),
          R = (!x && O) || P(d),
          U = ('Array' == e && T.entries) || O;
        if (
          (U &&
            (k = c(U.call(new t()))) !== Object.prototype &&
            k.next &&
            (o || c(k) === _ || (f ? f(k, _) : a(k[b]) || h(k, b, S)),
            l(k, A, !0, !0),
            o && (v[A] = S)),
          y &&
            'values' == d &&
          ...
          if (
            ...
            for (E in I) (x || C || !(E in T)) && h(T, E, I[E]);
          else r({ target: e, proto: !0, forced: x || C }, I);
        return (
          (o && !w) || T[b] === R || h(T, b, R, { name: d }), (v[e] = R), I
        );
      };
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      t.exports =
        ...
        s(function () {
          ...
          ? function (t, e) {
              for (
                var n = f(t), i = arguments.length, s = 1, p = u.f, h = c.f;
                i > s;
    ...
    function (t, e, n) {
      ...
      t.exports = function (t) {
        ...
        var y,
          ...
          k = 0;
        if (!w || (this === h && a(w)))
          for (y = c(e), m = n ? new this(y) : h(y); y > k; k++)
            (S = g ? v(e[k], k) : e[k]), f(m, k, S);
        else
          for (
            b = (x = l(e, w)).next, m = n ? new this() : [];
            !(_ = i(b, x)).done;
            k++
          )
            (S = g ? s(x, v, [_.value, k], !0) : _.value), f(m, k, S);
        return (m.length = k), m;
      };
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      var A = function (t) {
        ...
        O = function (t) {
          a.postMessage(I(t), r.protocol + '//' + r.host);
        };
      (_ && x) ||
        ((_ = function (t) {
        ...
        m
          ...
          : a.addEventListener &&
            ...
            'file:' !== r.protocol &&
            !p(O)
          ? ((i = O), a.addEventListener('message', T, !1))
          : (i =
    ...
    function (t, e, n) {
      ...
      var r = n(1),
        ...
        u = n(76);
      r(
        { target: 'Promise', stat: !0, forced: n(98) },
        {
    ...
    function (t, e, n) {
      ...
      ut.prototype = {
        ...
        parseObject: function (t) {
          var e,
            ...
            c = I(t);
          if (c)
            for (n = (e = k(t, c)).next; !(r = o(n, e)).done; ) {
              if (
                ((s = (i = k(_(r.value))).next),
                (a = o(s, i)).done || (u = o(s, i)).done || !o(s, i).done)
              )
                throw F('Expected sequence with length 2');
              z(this.entries, { key: b(a.value), value: b(u.value) });
            }
          else
            for (var f in t)
              g(t, f) && z(this.entries, { key: f, value: b(t[f]) });
        },
        parseQuery: function (t) {
          if (t)
            for (var e, n, r = J(t, '&'), i = 0; i < r.length; )
              (e = r[i++]).length &&
                ((n = J(e, '=')),
                z(this.entries, { key: nt(G(n)), value: nt(q(n, '=')) }));
        },
        serialize: function () {
          for (var t, e = this.entries, n = [], r = 0; r < e.length; )
            (t = e[r++]), z(n, st(t.key) + '=' + st(t.value));
          return q(n, '&');
        },
        update: function () {
      ...
      if (
        (f(
          ft,
          {
            append: function (t, e) {
              ...
              var n = O(this);
              z(n.entries, { key: b(t), value: b(e) }), n.updateURL();
            },
            delete: function (t) {
              E(arguments.length, 1);
              for (
                var e = O(this), n = e.entries, r = b(t), i = 0;
                i < n.length;
            ...
            get: function (t) {
              E(arguments.length, 1);
              for (var e = O(this).entries, n = b(t), r = 0; r < e.length; r++)
            ...
            getAll: function (t) {
              E(arguments.length, 1);
              for (
                var e = O(this).entries, n = b(t), r = [], i = 0;
                i < e.length;
                i++
              )
            ...
            has: function (t) {
              E(arguments.length, 1);
              for (var e = O(this).entries, n = b(t), r = 0; r < e.length; )
            ...
            set: function (t, e) {
              ...
              for (
                ...
                (n = i[u]).key === s &&
                  (o ? Q(i, u--, 1) : ((o = !0), (n.value = a)));
              o || z(i, { key: s, value: a }), r.updateURL();
            },
            sort: function () {
              var t = O(this);
        ...
        c(ft, C, ft.entries, { name: 'entries' }),
        c(
          ft,
          'toString',
          function () {
        ...
        r({ global: !0, constructor: !0, forced: !u }, { URLSearchParams: ct }),
        !u && v(j))
      ) {
        var lt = s(H.has),
          pt = s(H.set),
            ...
            if (x(t)) {
              ...
              if ('URLSearchParams' === m(n))
                return (
                  ...
                  S(t, { body: w(0, b(n)), headers: w(0, e) })
                );
            }
            return t;
          };
        if (
          (v(D) &&
            r(
              ...
              {
                fetch: function (t) {
                  return D(t, arguments.length > 1 ? ht(arguments[1]) : {});
                },
              }
            ),
          v(M))
          ...
          var dt = function (t) {
            return (
              d(this, N), new M(t, arguments.length > 1 ? ht(arguments[1]) : {})
            );
          };
          (N.constructor = dt),
            (dt.prototype = N),
      ...
      t.exports = { URLSearchParams: ct, getState: O };
    },
    function (t, e, n) {
      'use strict';
      var r,
    ...
    function (module, exports, __webpack_require__) {
         ...
         */ !(function () {
          ...
          (Sha1.prototype.update = function (t) {
            if (!this.finalized) {
              ...
              e &&
                t.constructor === root.ArrayBuffer &&
                (t = new Uint8Array(t));
              for (
                var n, r, i = 0, o = t.length || 0, s = this.blocks;
                i < o;
                ...
                if (
                  ...
                  for (r = this.start; i < o && r < 64; ++i)
                    (n = t.charCodeAt(i)) < 128
                      ? (s[r >> 2] |= n << SHIFT[3 & r++])
                      : n < 2048
                      ? ((s[r >> 2] |= (192 | (n >> 6)) << SHIFT[3 & r++]),
                        (s[r >> 2] |= (128 | (63 & n)) << SHIFT[3 & r++]))
                      : n < 55296 || n >= 57344
                      ? ((s[r >> 2] |= (224 | (n >> 12)) << SHIFT[3 & r++]),
                        (s[r >> 2] |=
      ...
      }).call(this, __webpack_require__(166), __webpack_require__(122));
    },
    function (t, e, n) {
      var r = new (n(419))(Math.random() * Number.MAX_SAFE_INTEGER);
      t.exports = function (t) {
        var e = t.length;
    ...
    function (t, e, n) {
      var r = n(201);
      n(233), n(234), n(235), n(236), n(237), n(238), n(239), (t.exports = r);
    },
    function (t, e, n) {
      var r = n(202);
      n(232), (t.exports = r);
    ...
    function (t, e, n) {
      ...
      var r = n(1),
        ...
        st = function (t) {
          ...
          return (
            !(this === W && l(Y, e) && !l(Z, e)) &&
            (!(n || !l(this, e) || !l(Y, e) || (l(this, H) && this[H][e])) || n)
          );
        },
        at = function (t, e) {
          var n = d(t),
          ...
          if (n !== W || !l(Y, r) || l(Z, r)) {
            var i = X(n, r);
            return (
              !i || !l(Y, r) || (l(n, H) && n[H][r]) || (i.enumerable = !0), i
            );
          }
        },
        ut = function (t) {
      ...
      c ||
        ...
        u &&
          ...
          a || P(W, 'propertyIsEnumerable', st, { unsafe: !0 }))),
        r(
      ...
      r(
        { target: 'Object', stat: !0, sham: !i },
        {
          getOwnPropertyDescriptors: function (t) {
            for (
              var e, n, r = s(t), i = a.f, c = o(r), f = {}, l = 0;
              c.length > l;
    ...
    function (t, e, n) {
      n(1)({ target: 'Object', stat: !0 }, { setPrototypeOf: n(94) });
    },
    function (t, e, n) {
      t.exports = n(281);
    },
    ...
    function (t, e, n) {
      n(1)({ target: 'Object', stat: !0, sham: !n(15) }, { create: n(55) });
    },
    function (t, e, n) {
      var r = n(117),
        i = n(118);
    ...
    function (t, e, n) {
      n(1)({ target: 'Array', stat: !0 }, { isArray: n(54) });
    },
    function (t, e, n) {
      var r = n(108),
        i = n(325);
        ...
        { target: 'Array', proto: !0, forced: !d },
        {
          slice: function (t, e) {
            ...
            if (
              ...
              return h(p, m, _);
            for (
              r = new (void 0 === n ? g : n)(y(_ - m, 0)), l = 0;
              m < _;
              m++, l++
            )
              m in p && f(r, l, p[m]);
    ...
    function (t, e, n) {
      var r = n(15),
        ...
        c = function (t) {
          return function (e) {
            for (
              var n, i = s(e), c = o(i), f = c.length, l = 0, p = [];
              f > l;

            )
              (n = c[l++]), (r && !a(i, n)) || u(p, t ? [n, i[n]] : i[n]);
            return p;
          };
        };
      ...
      function h() {
        ...
        function b(t, e, n, r) {
          var i = e && e.prototype instanceof k ? e : k,
            o = s(i.prototype),
            a = new M(r || []);
          return v(o, '_invoke', { value: R(t, n, a) }), o;
        }
        function S(t, e, n) {
          try {
        ...
        var C = (E.prototype = k.prototype = s(P));
        function T(t) {
          var e;
                ...
                return new e(function (n, s) {
                  !(function n(i, o, s, a) {
                    ...
                    if ('throw' !== u.type) {
                      var c = u.arg,
                        f = c.value;
                      return f && 'object' == r(f) && d.call(f, '__await')
        ...
        function R(t, e, n) {
          ...
          return function (i, o) {
            ...
            for (n.method = i, n.arg = o; ; ) {
              ...
              if ('normal' === u.type) {
                if (
                  ((r = n.done ? 'completed' : 'suspendedYield'), u.arg === w)
                )
                  continue;
        ...
        return (
          (I.prototype = E),
          v(C, 'constructor', { value: E, configurable: !0 }),
          v(E, 'constructor', { value: I, configurable: !0 }),
          (I.displayName = x(E, _, 'GeneratorFunction')),
          ...
          (e.mark = function (t) {
            return (
              c ? c(t, E) : ((t.__proto__ = E), x(t, _, 'GeneratorFunction')),
              (t.prototype = s(C)),
              t
            );
          }),
          ...
          T(O.prototype),
          x(O.prototype, m, function () {
            return this;
          }),
          (e.AsyncIterator = O),
          (e.async = function (t, n, r, i, o) {
            void 0 === o && (o = f);
            var s = new O(b(t, n, r, i), o);
    ...
    function (t, e, n) {
      var r = n(360);
      n(384), n(385), n(386), n(387), (t.exports = r);
    },
    function (t, e, n) {
      var r = n(164);
      t.exports = r;
    ...
    function (t, e, n) {
      n(165), n(50), n(88), n(369), n(173), n(174), n(383), n(58);
      var r = n(8);
      t.exports = r.Promise;
    },
    function (t, e, n) {
      ...
      var r = n(1),
        ...
        m = function (t, e) {
          ...
          s
            ? (n = s(g(), r ? o(this) : _))
            : ((n = r ? this : u(_)), c(n, v, 'Error')),
            void 0 !== e && c(n, 'message', d(e)),
            p(n, m, n.stack, 1),
            arguments.length > 2 && l(n, arguments[2]);
          var a = [];
          return h(t, y, { that: a }), c(n, 'errors', a), n;
        };
    ...
    function (t, e, n) {
      n(370), n(378), n(379), n(380), n(381), n(382);
    },
    function (t, e, n) {
      'use strict';
      var r,
      ...
      if (
        ...
        (A.f = B =
          function (t) {
            return t === D || void 0 === t ? new i(t) : F(t);
          }),
        !a && g(E) && L !== Object.prototype)
      ) {
        (o = L.then),
          O ||
            l(
      ...
      s({ global: !0, constructor: !0, wrap: !0, forced: C }, { Promise: D }),
        h(D, 'Promise', !1, !0),
        d('Promise');
    },
    function (t, e, n) {
    ...
    function (t, e, n) {
      ...
      if (!S) {
        ...
        h || g || v || !y || !m
          ...
          : ((i = !0),
            (o = m.createTextNode('')),
            new y(k).observe(o, { characterData: !0 }),
            (r = function () {
              o.data = i = !i;
            })),
          (S = function (t) {
    ...
    function (t, e, n) {
      ...
      var r = n(1),
        ...
        o = n(44);
      r(
        { target: 'Promise', stat: !0, forced: n(77).CONSTRUCTOR },
        {
          reject: function (t) {
            var e = o.f(this);
    ...
    function (t, e) {
      ...
      (n.prototype.init_seed = function (t) {
        ...
        (n.prototype.init_by_array = function (t, e) {
          var n, r, i;
          for (
            this.init_seed(19650218), n = 1, r = 0, i = this.N > e ? this.N : e;
            i;
            i--
          ) {
    ...
    function (t, e, n) {
      ...
      var r,
        ...
        nt = function (t) {
          var e, n, r, i;
          if ('number' == typeof t) {
            for (e = [], n = 0; n < 4; n++) K(e, t % 256), (t = O(t / 256));
            return D(e, '.');
          }
          if ('object' == typeof t) {
            for (
        ...
        ut = { ftp: 21, file: null, http: 80, https: 443, ws: 80, wss: 443 },
        ct = function (t, e) {
          var n;
          return (
            2 == t.length &&
      ...
      Ut.prototype = {
                ...
                if (o && (L(z, o) || '+' == o || '-' == o || '.' == o))
                  ...
                  (p = ''),
                    'file' == c.scheme
                      ...
                      : '/' == i[l + 1]
                      ? ((f = gt), l++)
                      : ((c.cannotBeABaseURL = !0), N(c.path, ''), (f = Tt));
                }
                break;
              case dt:
        ...
        parseHost: function (t) {
          ...
          if ('[' == U(t, 0)) {
            ...
            if (((t = m(t)), L(Y, t))) return 'Invalid host';
            if (
              null ===
              (e = (function (t) {
                var e,
                ...
                for (n = [], r = 0; r < e; r++) {
                  ...
                  if (
                    ...
                    i.length > 1 &&
                      '0' == U(i, 0) &&
                      ((o = L(G, i) ? 16 : 8), (i = W(i, 8 == o ? 1 : 2))),
                    '' === i)
                  )
                    s = 0;
                  else {
                    if (!L(10 == o ? J : 8 == o ? Q : $, i)) return t;
                    s = T(i, o);
                  }
                  N(n, s);
                }
          ...
          return (
            null !== i
              ? ((c += '//'),
                ...
                null !== o && (c += ':' + o))
              : 'file' == e && (c += '//'),
            (c += t.cannotBeABaseURL ? s[0] : s.length ? '/' + D(s, '/') : ''),
            null !== a && (c += '?' + a),
            null !== u && (c += '#' + u),
            c
          );
        ...
        setPort: function (t) {
          this.cannotHaveUsernamePasswordPort() ||
            ('' == (t = _(t)) ? (this.port = null) : this.parse(t, kt));
        },
      ...
      if (
        (o &&
          (l(Dt, 'href', Mt('serialize', 'setHref')),
          l(Dt, 'origin', Mt('getOrigin')),
          l(Dt, 'protocol', Mt('getProtocol', 'setProtocol')),
          l(Dt, 'username', Mt('getUsername', 'setUsername')),
          l(Dt, 'password', Mt('getPassword', 'setPassword')),
          l(Dt, 'host', Mt('getHost', 'setHost')),
          l(Dt, 'hostname', Mt('getHostname', 'setHostname')),
          l(Dt, 'port', Mt('getPort', 'setPort')),
          l(Dt, 'pathname', Mt('getPathname', 'setPathname')),
          l(Dt, 'search', Mt('getSearch', 'setSearch')),
          l(Dt, 'searchParams', Mt('getSearchParams')),
          l(Dt, 'hash', Mt('getHash', 'setHash'))),
        f(
          Dt,
          'toJSON',
          function () {
        ...
        jt && f(Lt, 'createObjectURL', u(jt, A)),
          Nt && f(Lt, 'revokeObjectURL', u(Nt, A));
      }
      x(Lt, 'URL'),
        i({ global: !0, constructor: !0, forced: !s, sham: !o }, { URL: Lt });
    },
    function (t, e, n) {
      var r = n(27);
      t.exports = function (t, e, n) {
    ...
    function (t, e, n) {
      var r = n(6),
        ...
        m = function (t, e, n) {
          var r = 0;
          for (t = n ? c(t / 700) : t >> 1, t += c(t / e); t > 455; )
            (t = c(t / 35)), (r += 36);
    ...
    function (t, e, n) {
      ...
      var h = n(2),
        ...
        ut = 'singular_id',
        ct = 'singular_instance_id',
        ft = 'singular_storage_enabled_test',
        lt = 'test_value',
        pt = 'last_event_timestamp',
        ht = 'touchpoint_timestamp',
        dt = 'web_url',
        vt = { Local: 'local', Session: 'session', Memory: 'memory' },
        gt = 'n',
        yt = 'browser_available_memory',
        mt = 'browser_used_memory',
        _t = 'counter_banner_showed',
        xt = 'source_url',
        bt = 'client_hints',
        St = 'custom_user_id',
        wt = 'current_device_time',
        kt = '_dl',
        It = '_ddl',
        Et = 'document_referrer',
        Pt = 'event_id',
        At = 'n',
        Ct = 'product_name',
        Tt = 'e',
        ...
        Jt = 'screen_width',
        $t = 'sdid_persist_mode',
        Yt = 'sdid_persist_failed_reason',
        Zt = 'sdk',
        te = 's',
        ee = 'SDID',
        ne = 'singular_instance_id',
        re = 'storage_type',
        ie = 'timezone',
        oe = 'touchpoint_timestamp',
        se = 'device_user_agent',
        ae = 'u',
        ue =
        ...
        ge = 'https://sdk-api-v1.singular.net/api/v1/',
        ye = 'Content-Type',
        me = 'application/json',
        _e = {
          Session: 'start',
        ...
        Me = ['Win32', 'Win64', 'Windows', 'WinCE'],
        je = 3,
        Ne = 2,
        He = 1,
        Be = 0,
        Fe = ['platformVersion', We, 'uaFullVersion', 'model', 'architecture'],
        We = 'platform',
        Ve = 'domain',
        Ke = 'expires',
        qe = 864e5,
        ze = 365 * qe,
        Xe = 'singular_device_id',
        Ge = n(181),
        Qe = n.n(Ge),
        Je = n(182),
        $e = n.n(Je),
            ...
            g()(t, null, [
              {
                ...
                value: function () {
                  ...
                  return (
                    (t &&
                      t.getRandomValues &&
                      t.getRandomValues(new Uint8Array(1))) ||
                      (t = {
                          ...
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 4:
                                if (
                                  ((o = t.sent),
                                  !en()((e = c.MacOsPlatforms)).call(e, i))
                                ) {
                                  t.next = 9;
                                  break;
                                }
                              ...
                              case 9:
                                if (
                                  !en()((n = c.iOSPlatforms)).call(n, i) &&
                                  !/iPad|iPhone|iPod/.test(o)
                                ) {
                                  t.next = 13;
                                  break;
                                }
                              ...
                              case 13:
                                if (
                                  !en()((r = c.WindowsPlatforms)).call(r, i)
                                ) {
                                  t.next = 17;
                                  break;
                                }
              ...
              },
              {
                ...
                value: function () {
                  try {
                    return window.performance.hasOwnProperty('memory') &&
                      window.performance.memory.hasOwnProperty(
                        'jsHeapSizeLimit'
                      )
              ...
              },
              {
                ...
                value: function (t, e, n, r, i) {
                  ...
                  var f = Ze()((o = L()(u))).call(o, function (t) {
                    var e;
                    return fn()(
                      (e = ''.concat(encodeURIComponent(t), '='))
                    ).call(e, encodeURIComponent(u[t]));
                  });
                  return fn()(
                    (s = ''.concat(this.extractUrlWithPath(t), '?'))
                  ).call(s, f.join('&'));
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  var e = t.split('?');
                  return (e.length >= 2 && !this.isNullOrEmpty(e[1])) ||
                    ((e = t.split('#')).length >= 2 &&
                      !this.isNullOrEmpty(e[1]))
                    ? e[1]
                    : '';
                },
              },
                  ...
                  if (
                    ...
                    document.cookie = fn()(
                      (i = fn()(
                        (o = fn()(
                          (s = fn()(
                            (a = fn()((u = ''.concat(e, '='))).call(
                              u,
                              encodeURIComponent(n),
                              '; '
                            ))
                          ).call(a, p.CookieDomainKey, '='))
                        ).call(s, r, '; '))
                      ).call(o, p.CookieExpiresKey, '='))
                    ).call(i, c.toGMTString(), '; path=/');
                  }
                },
              },
              {
                        ...
                        function (t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 2:
                                return (
                                  (t.next = 4), this._getClientHintsPlatform()
                                );
                              case 4:
                  ...
                  try {
                    for (
                      ...
                      for (var c in a.WebUrlMarketingParams) {
                        ...
                        try {
                          for (
                            var h, d = xn()(a.WebUrlMarketingParams[c]);
                            !(f = (h = d.next()).done);
                            f = !0
                          ) {
                            var v = h.value;
              ...
              },
              {
                ...
                value: function (t, e, n) {
                  ...
                  return fn()(
                    (r = fn()(
                      (i = fn()((o = ''.concat(n.split(t)[0], '?'))).call(o, e))
                    ).call(i, '?' == t ? '&' : '#'))
                  ).call(r, n.split(t)[1]);
                },
              },
      ...
      var On = (function () {
        function t(e, n) {
          d()(this, t),
            ...
            e === s.Types.Local && t._isLocalStorageAvailable()
              ? (this._storage = localStorage)
              : (e !== s.Types.Local && e !== s.Types.Session) ||
                !t._isSessionStorageAvailable()
            ...
            [
              {
                ...
                value: function (t) {
                  var e;
                  return Cn.isNullOrEmpty(t) || !this._isInitialized
                    ? null
                    : this._storage.getItem(
                        fn()((e = ''.concat(this._storagePrefix, '_'))).call(
                          e,
                          t
                        )
                      );
                ...
                value: function (t, e) {
                  ...
                  !Cn.isNullOrEmpty(t) &&
                    ...
                    this._storage.setItem(
                      fn()((n = ''.concat(this._storagePrefix, '_'))).call(
                        n,
                        t
                      ),
                      e
                ...
                value: function (t) {
                  ...
                  !Cn.isNullOrEmpty(t) &&
                    ...
                    this._storage.removeItem(
                      fn()((e = ''.concat(this._storagePrefix, '_'))).call(e, t)
                    );
                },
              },
              {
                  ...
                  return (
                    this._availableStorageType ||
                      (this._isLocalStorageAvailable()
                        ? (this._availableStorageType = s.Types.Local)
                        : this._isSessionStorageAvailable()
                        ? (this._availableStorageType = s.Types.Session)
                        : (this._availableStorageType = s.Types.Memory)),
                    this._availableStorageType
                  );
                },
              },
                ...
                value: function () {
                  ...
                  try {
                    localStorage.setItem(
                      s.StorageEnabledTestKey,
                      s.StorageEnabledTestValue
                    );
                    var t =
                      localStorage.getItem(s.StorageEnabledTestKey) ===
                      s.StorageEnabledTestValue;
              ...
              },
              {
                ...
                value: function () {
                  ...
                  try {
                    ...
                    var t =
                      sessionStorage.getItem(s.StorageEnabledTestKey) ===
                      s.StorageEnabledTestValue;
                    return (
                      sessionStorage.removeItem(s.StorageEnabledTestKey), t
                    );
                  } catch (t) {
                    return !1;
                  }
      ...
      m()(On, '_availableStorageType', void 0);
      var Rn = (function () {
        function t() {
          d()(this, t);
        }
            ...
            [
              {
                ...
                value: function (t) {
                  return (
                    ...
                    (this._storage = new On(
                      s.Types.Local,
                      this.getStoragePrefix()
                    )),
                    (this._singularDeviceIdStorage = new On(
                      s.Types.Local,
                      s.GlobalStoragePrefix
                    )),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  !t ||
                  this._isWebUrlContainingMarketingData(window.location.href)
                    ? ((this._webUrl = window.location.href),
                      (this._touchpointTimestamp = Cn.getCurrentTimestamp()),
                      this._storage.setItem(s.StorageWebUrlKey, this._webUrl),
                      this._storage.setItem(
                        s.StorageTouchpointTimestampKey,
                        this._touchpointTimestamp
                      ),
                      (this._newSessionIdNeeded = !0))
                    : ((this._webUrl = t), (this._touchpointTimestamp = e));
                },
              },
              {
                ...
                value: function () {
                  ...
                  var t = this._singularDeviceIdStorage.getItem(
                    s.SingularDeviceIdKey
                  );
                  if (this._singularConfig._singularDeviceId)
                    (this._sdidPersistMode = r.SdidPersistModeManual),
                      Cn.isUUID(this._singularConfig._singularDeviceId)
                        ? (Tn.debug(
                            'Persistent Singular Device Id was set manually'
                          ),
                          this._singularDeviceIdStorage.setItem(
                            s.SingularDeviceIdKey,
                            this._singularConfig._singularDeviceId
                          ))
                        : (Tn.debug(
                            'Persistent Singular Device Id provided was not in uuid format'
                          ),
                          (this._sdidPersistFailReason = 'invalid udid:'.concat(
                            this._singularConfig._singularDeviceId
                          )));
                  else if (
                    !Cn.isNullOrEmpty(this._singularConfig._autoPersistDomain)
                  ) {
                    var e = Cn.getCookie(p.SingularDeviceIdKey);
                    (this._sdidPersistMode = r.SdidPersistModeAuto),
                      null != e &&
                        ('' === e
                          ? (this._sdidPersistFailReason =
                              'singular sdid cookie was set to an empty string')
                          : Cn.isUUID(e)
                          ? (Tn.debug(
                              'Persistent Singular Device Id was set automatically from cookies'
                            ),
                            this._singularDeviceIdStorage.setItem(
                              s.SingularDeviceIdKey,
                              e
                          ...
                          : (this._sdidPersistFailReason =
                              'invalid udid:'.concat(e)));
                  }
                  return (
                    (this._singularDeviceId = this._getPersistentUUID(
                      this._singularDeviceIdStorage,
                      s.SingularDeviceIdKey
                    )),
                    Cn.isNullOrEmpty(t) ||
                      this._singularDeviceId === t ||
                      (this._previousSdid = t),
              ...
              },
              {
                ...
                value: function () {
                  var t;
                  return fn()(
                    (t = ''.concat(this._singularConfig.apikey, '_'))
                  ).call(t, this._singularConfig.productId);
                },
              },
              {
                key: 'getCustomUserId',
                value: function () {
                  return (
                    this._customUserId ||
                      (this._customUserId = this._storage.getItem(
                        s.CustomUserIdKey
                      )),
                    this._customUserId
                  );
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this._instanceId ||
                      (this._instanceId = this._getPersistentUUID(
                        this._storage,
                        s.SingularInstanceIdKey
                      )),
                    this._instanceId
                  );
                },
              ...
              },
              {
                ...
                value: function () {
                  return (
                    null !== this._isFirstVisit ||
                      ((this._isFirstVisit = !this._storage.getItem(
                        s.DidVisitSiteKey
                      )),
                      this._isFirstVisit &&
                        this._storage.setItem(s.DidVisitSiteKey, !0)),
                    this._isFirstVisit
                  );
                },
              },
              {
                ...
                value: function (t) {
                  var e,
                    n = fn()((e = ''.concat(s.DidSendEventKeyBase, '.'))).call(
                      e,
                      t
                    ),
              ...
              },
              {
                ...
                value: function () {
                  this._storage.setItem(
                    s.StorageLastEventTimestamp,
                    Cn.getCurrentTimestamp()
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t, e) {
                  var n = t.getItem(e);
                  return n || ((n = Cn.generateUUID()), t.setItem(e, n)), n;
                },
              },
              {
                ...
                value: function (t) {
                  for (var e in a.WebUrlMarketingParams) {
                    ...
                    try {
                      for (
                        var o, s = xn()(a.WebUrlMarketingParams[e]);
                        !(n = (o = s.next()).done);
                        n = !0
                      ) {
                        var u = o.value;
              ...
              },
              {
                ...
                value: function () {
                  return (
                    this._newSessionIdNeeded ||
                    !this.getSessionId() ||
                    !this._getLastEventTimestamp() ||
              ...
              },
              {
                ...
                value: function () {
                  return (
                    Cn.getCurrentTimestamp() - this._getLastEventTimestamp() >
                    this._singularConfig.sessionTimeOutInSeconds
                  );
                },
              },
              {
                ...
                value: function () {
                  return (this._newSessionIdNeeded = !1), Cn.generateUUID();
                },
              },
              {
                ...
                value: function () {
                  Cn.isNullOrEmpty(this._singularConfig._autoPersistDomain) ||
                    Cn.setCookie(
                      p.SingularDeviceIdKey,
                      this.getSingularDeviceId(),
                      this._singularConfig._autoPersistDomain
                    );
                },
              },
            ],
      ...
      function Ln(t) {
        for (var e = 1; e < arguments.length; e++) {
          ...
          if (e % 2)
            E()((n = Un(r, !0))).call(n, function (e) {
              m()(t, e, r[e]);
            });
          else if (k.a) S()(t, k()(r));
          else {
            var i;
            E()((i = Un(r))).call(i, function (e) {
              x()(t, e, A()(r, e));
            });
          }
        }
      ...
      var Dn = (function () {
        function t() {
          d()(this, t),
            ...
            this.initApiParams(),
            Rn.getInstance().updateLastEventTimestamp();
        }
        var e;
        return (
          g()(
            ...
            [
              {
                ...
                value: function () {
                  ...
                  this._params =
                    ...
                    m()(
                      t,
                      a.BrowserAvailableMemory,
                      Cn.getBrowserAvailableMemory()
                    ),
                    m()(t, a.BrowserUsedMemory, Cn.getBrowserUsedMemory()),
                    m()(t, a.CustomUserId, Rn.getInstance().getCustomUserId()),
                    m()(t, a.CurrentDeviceTime, Cn.getCurrentTimestamp()),
                    m()(t, a.EventId, Cn.generateUUID()),
                    m()(t, a.IsConversion, !1),
                    m()(t, a.Keyspace, a.SingularDeviceId),
                    m()(
                      t,
                      a.Owner,
                      Rn.getInstance().getSingularConfig().apikey
                    ),
                    m()(t, a.Platform, a.PlatformWeb),
                    m()(
                      t,
                      a.ProductId,
                      Rn.getInstance().getSingularConfig().productId
                    ),
                    m()(t, a.ScreenHeight, window.screen.height),
                    m()(t, a.ScreenWidth, window.screen.width),
                    m()(t, a.SdkVersion, Cn.getSdkVersion()),
                    m()(
                      t,
                      a.SingularInstanceId,
                      Rn.getInstance().getSingularInstanceId()
                    ),
                    m()(
                      t,
                      a.SingularDeviceId.toLowerCase(),
                      Rn.getInstance().getSingularDeviceId()
                    ),
                    m()(t, a.StorageType, On.getAvailableStorageType()),
                    m()(t, a.Timezone, Cn.getTimeZone()),
                    m()(
                      t,
                      a.TouchpointTimestamp,
                      Rn.getInstance().getTouchpointTimestamp()
                    ),
                    m()(t, a.UserAgent, navigator.userAgent),
                    m()(t, a.UUID, Rn.getInstance().getSingularDeviceId()),
                    t);
                },
              },
              {
                      ...
                      return un.a.wrap(
                        function (t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (t.next = 2), Cn.getOS();
                              case 2:
                                return (
                                  (this._params[a.OS] = t.sent),
                                  (t.next = 5),
                                  Cn.getClientHints()
                                );
                              case 5:
                                return (
                                  (e = t.sent) &&
                                    (this._params[a.ClientHints] = gn()(e)),
                                  t.abrupt(
                                    'return',
                                    new dn.a(function (t) {
                                      var e;
                                      L()(n._extra).length > 0 &&
                                        (n._params[a.Extra] = gn()(n._extra)),
                                        n._params[a.SessionId] ||
                                          (n._params[a.SessionId] =
                                            Rn.getInstance().getSessionId());
                                      var r = Ln(
                                          {},
                                          n._params,
                                          m()(
                                            ...
                                            Cn.getCurrentTimestamp() -
                                              pn()(
                                                n._params[a.CurrentDeviceTime]
                                              )
                                          )
                                        ),
                                        i =
                                          n._method === u.PostMethod
                                            ? n._buildRequestBody(r)
                                            : null,
              ...
              },
              {
                ...
                value: function (t) {
                  try {
                    ...
                    return (
                      t.status === u.ValidResponseCode &&
                      e[u.Status] === u.ValidResponse
                    );
                  } catch (t) {
                    return !1;
                  }
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  if (
                    (E()(
                      (e = T()((n = sn()(t))).call(n, function (t) {
                        var e,
                          n = rn()(t, 2),
                          r = n[0],
                          i = n[1];
                        return (
                          en()((e = u.PostParams)).call(e, r) &&
                          !Cn.isNullOrEmpty(i)
                        );
                      }))
                    ).call(e, function (t) {
                  ...
                  return {
                    payload: i,
                    signature: Cn.calculateHash(
                      i,
                      Rn.getInstance().getSingularConfig().secret
                    ),
                  };
                },
              },
              {
                ...
                value: function (t) {
                  var e,
                    ...
                    i = this,
                    o = Ze()(
                      (e = T()((n = L()(t))).call(n, function (e) {
                        var n;
                        return (
                          !Cn.isNullOrEmpty(t[e]) &&
                          (i._method !== u.PostMethod ||
                            !en()((n = u.PostParams)).call(n, e))
                        );
                      }))
                    ).call(e, function (e) {
                      var n;
                  ...
                  return fn()((r = ''.concat(s, '&h='))).call(r, a);
                },
              },
              {
            ...
            [
              {
                key: 'toJsonString',
                value: function (t) {
                  return Cn.isNullOrEmpty(t) ? null : gn()(t);
                },
              },
              {
                key: 'fromJsonString',
                value: function (t) {
                  if (Cn.isNullOrEmpty(t)) return null;
                  var e = JSON.parse(t),
                    n = $e()(this.apiClasses[e._apiType].prototype);
                  return Qe()(n, e), n;
                },
              },
            ]
      ...
      function jn(t) {
        for (var e = 1; e < arguments.length; e++) {
          var n,
            r = null != arguments[e] ? arguments[e] : {};
          if (e % 2)
            E()((n = Mn(r, !0))).call(n, function (e) {
              m()(t, e, r[e]);
            });
          else if (k.a) S()(t, k()(r));
          else {
            var i;
            E()((i = Mn(r))).call(i, function (e) {
              x()(t, e, A()(r, e));
            });
          }
        }
      ...
      var Nn = (function (t) {
        function e(t) {
          var n, r;
          if ((d()(this, e), Cn.isNullOrEmpty(t)))
            throw new Error('eventName must not be null or empty');
          return (
            ((r = M()(this, N()(e).call(this)))._apiType = o.EventApi),
            ...
            (r._params = jn(
              ...
              m()(
                n,
                a.EventProductName,
                Rn.getInstance().getSingularConfig().productName
              ),
              m()(n, a.EventName, t),
              m()(n, a.IsRevenueEvent, !1),
              m()(n, a.IsFirstEvent, Rn.getInstance().IsFirstEvent(t)),
              n)
            )),
            r
          );
        ...
        return (
          ...
          g()(e, [
            ...
            },
            {
              key: 'withArgs',
              value: function (t) {
                return t && 0 !== L()(t).length
                  ? ((this._extra = jn({}, this._extra, {}, t)), this)
                  : this;
              },
            },
          ]),
      ...
      var Bn,
        Fn = (function (t) {
          function e(t) {
            ...
            return (
              d()(this, e),
              ((r = M()(this, N()(e).call(this, t)))._apiType =
              ...
              (r._params = (function (t) {
                for (var e = 1; e < arguments.length; e++) {
                  var n,
                    r = null != arguments[e] ? arguments[e] : {};
                  if (e % 2)
                    E()((n = Hn(r, !0))).call(n, function (e) {
                      m()(t, e, r[e]);
                    });
                  else if (k.a) S()(t, k()(r));
                  else {
                    var i;
                    E()((i = Hn(r))).call(i, function (e) {
                      x()(t, e, A()(r, e));
                    });
                  }
                }
                ...
                m()(n, a.WebUrl, Rn.getInstance().getWebUrl()),
                n)
              )),
              r
            );
        ...
        zn = (function () {
          function t() {
            d()(this, t),
              (this._storage = new On(
                s.Types.Session,
                Rn.getInstance().getStoragePrefix()
              )),
            ...
            g()(t, [
              {
                ...
                value: function (t) {
                  Cn.isNullOrEmpty(t) ||
                    !(t instanceof Dn) ||
                    this._queue.length >= s.MaxApisInQueue ||
                    (Tn.debug('Enqueued api:'.concat(gn()(t))),
                    this._queue.push(Dn.toJsonString(t)),
              ...
              },
              {
                ...
                value: function () {
                  ...
                  var t = Dn.fromJsonString(this._queue.shift());
                  return (
                    this._saveQueueToStorage(),
                    Tn.debug('Dequeued api:'.concat(gn()(t))),
                    t
                  );
                },
              },
              {
                ...
                value: function () {
                  return this.isQueueEmpty()
                    ? null
                    : Dn.fromJsonString(this._queue[0]);
                },
              },
              {
                key: 'isQueueEmpty',
              ...
              },
              {
                ...
                value: function () {
                  this._storage.setItem(s.ApiQueueKey, gn()(this._queue));
                },
              },
              {
                ...
                value: function () {
                  ...
                  return t
                    ? (Tn.info('Api queue loaded from storage'), JSON.parse(t))
                    : [];
                },
              },
            ]),
        ...
        Qn = (function (t) {
          function e() {
            var t;
            d()(this, e);
            var n = Rn.getInstance().getSessionIdForPageVisit();
            ((t = M()(this, N()(e).call(this, o.PageVisitEventName)))._apiType =
              o.PageVisitApi),
              (t._params[a.SessionId] = n),
              (t._params[a.WebUrl] = window.location.href),
              (t._params[a.DocumentReferrer] = document.referrer),
              (t._params[a.IsFirstVisit] = Rn.getInstance().isFirstVisit()),
              (t._params[a.IsPageRefreshed] = Cn.isPageRefreshed()),
              (t._params[a.SdidPersistMode] =
                Rn.getInstance().getSdidPersistMode());
            var r = Rn.getInstance().getSdidPersistFailReason();
            Cn.isNullOrEmpty(r) || (t._params[a.SdidPersistFailedReason] = r);
            var i = Rn.getInstance().getPreviousSdid();
            return Cn.isNullOrEmpty(i) || (t._params[a.PreviousSdid] = i), t;
          }
          return (
            B()(e, t),
            g()(e, [
              {
                key: 'handleResponse',
                value: function (t) {
                  var n = Gn()(N()(e.prototype), 'handleResponse', this).call(
                    this,
                    t
                  );
                  return (
                    n &&
                      Rn.getInstance().saveSessionId(this._params[a.SessionId]),
                    n
                  );
                },
              },
        ...
        Jn = (function (t) {
          function e() {
            ...
            return (
              d()(this, e),
              ((t = M()(this, N()(e).call(this)))._apiType =
                o.CustomUserIdEventApi),
            ...
            g()(t, [
              {
                key: 'sendApi',
                value: function (t) {
                  if (!Cn.isNullOrEmpty(t) && t instanceof Dn)
                    return (
                      this._storageQueue.enqueue(t), this._startSendingApis()
                    );
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  Dn.apiClasses =
                    ((t = {}),
                    m()(t, o.ConversionEventApi, Fn),
                    m()(t, o.CustomUserIdEventApi, Jn),
                    m()(t, o.EventApi, Nn),
                    m()(t, o.PageVisitApi, Qn),
                    t);
                },
              },
            ]),
        ...
        nr = (function (t) {
          function e() {
            var t, n;
            d()(this, e),
              ((n = M()(this, N()(e).call(this)))._apiType = o.FetchBannerApi),
              (n._method = u.GetMethod),
              (n._endpoint = u.Endpoints.FetchBanner);
            var r = Rn.getInstance();
            return (
              (n._params =
                ((t = {}),
            ...
            g()(e, [
                        ...
                        function (t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              case 0:
                                return (
                                  (this._params[a.BannerSourceUrl] =
                                    location.href),
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  return fn()(
                    (e = fn()(
                      (n = ''.concat(u.BaseUrl.replace('v1/', '')))
                    ).call(n, this._endpoint))
                  ).call(e, t);
                },
              },
              {
                ...
                value: function (t) {
                  var e = t.display,
                    n = t.meta;
                  return e && n
                    ? u.FetchBannerResponseLinkKey in n
                    : (Tn.debug(
                        'BannerApi.isValidResponse: missing display or meta keys'
                      ),
                      !1);
                },
              },
              {
                ...
                value: function (t) {
                  try {
                    Tn.debug(
                      'handeling response of banner request: '.concat(t)
                    );
                    var e = JSON.parse(t.responseText);
                    if (!e) return;
                    return t.status === u.ValidResponseCode &&
                      this.isValidResponse(e)
                      ? e
                      : void Tn.debug('response is not valid');
                  } catch (t) {
                    Tn.debug('error processing response');
                  }
                },
              },
            ]),
          ...
          function t() {
            d()(this, t),
              m()(this, 'getBannerLastDismissed', function () {
                return Rn.getInstance()._storage.getItem(
                  s.BannerLastDismissedKey
                );
              }),
              m()(this, 'setBannerLastDismissed', function () {
                Rn.getInstance()._storage.setItem(
                  s.BannerLastDismissedKey,
                  Cn.getCurrentTimestamp()
                );
              }),
              (this.isShowingBanner = !1),
              (this.bannersAPI = new nr()),
              (this.bannerElement = this.htmlToElement(this.fetchTemplate())),
              (this.bannerStyle = null),
              (this.closeButton = this.bannerElement.getElementsByClassName(
                'singular-banner-close-button'
              )[0]),
              (this.downloadButton = this.bannerElement.getElementsByClassName(
                'singular-banner-download-button'
              )[0]),
              this.onCloseClick,
          ...
          return (
            g()(t, [
              ...
              },
              {
                key: 'fetchBanner',
                value: function () {
                  return this.bannersAPI.sendRequest(
                    this.getBannerLastDismissed()
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t, e) {
                  var n,
                    ...
                    o = i.placement,
                    s = i.css,
                    a = er()(i, ['placement', 'css']),
                    u = t.meta;
                  this.setBannerStyle(s),
                    E()((n = sn()(a))).call(n, function (t) {
                      var e = rn()(t, 2),
                        n = e[0],
                        i = e[1],
                      ...
                      s &&
                        ('IMG' === s.nodeName
                          ? (s.src = i)
                          : ('DIV' !== s.nodeName && 'SPAN' !== s.nodeName) ||
                        ...
                        function (t) {
                          for (;;)
                            switch ((t.prev = t.next)) {
                              ...
                              case 4:
                                return (
                                  (i = this.enrichLinkData(r, n)),
                                  (t.prev = 5),
                                  (t.next = 8),
                                  fetch(i, { mode: 'no-cors' })
                                );
                              case 8:
                                t.next = 13;
                                break;
                              case 10:
                                (t.prev = 10),
                                  ...
                                  Tn.debug(
                                    fn()(
                                      (o =
                                        'failed to send banner impression '.concat(
                                          i,
                                          ', error: '
                                        ))
                                    ).call(o, t.t0)
              ...
              },
              {
                ...
                value: function (t) {
                  var e;
                  return fn()((e = ''.concat('singular-banner-'))).call(
                    e,
                    t.replace('_', '-')
                  );
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  return (e.innerHTML = kn()(t).call(t)), e.firstChild;
                },
              },
              {
                key: 'prepareLink',
                  ...
                  var n,
                    r =
                      arguments.length > 2 && void 0 !== arguments[2]
                        ? arguments[2]
                        : {},
                    i = Rn.getInstance().getSingularConfig(),
                    o = i.bannersOptions,
                    s = t;
                  o &&
                    o.isWebToAppSupported &&
                    (s = vr.buildWebToAppLink(t) || t);
                  var u = new qn.a(s);
                  return (
                    u.searchParams.set(a.Source, 'Organic Banner'),
                    E()((n = sn()(r))).call(n, function (t) {
                      var e = rn()(t, 2),
                        n = e[0],
                        r = e[1];
              ...
              },
              {
                ...
                value: function () {
                  var t = this,
                    e = location.href;
                  this.urlChangeInterval = Zn()(function () {
                    e != location.href &&
                      ((e = location.href), t.hideBanner(), t.showBanner());
                  }, 500);
                },
              },
              {
      ...
      for (
        var ar = function (t) {
            return 'string' == typeof t && sr.test(t);
          },
          ur = [],
          cr = 0;
        cr < 256;
        ...
        ur.push((cr + 256).toString(16).substr(1));
      var fr = function (t) {
        var e =
        ...
        if (!ar(n)) throw TypeError('Stringified UUID is invalid');
        return n;
      };
      var lr = function (t, e, n) {
          var r = (t = t || {}).random || (t.rng || or)();
        ...
        pr = (function () {
          function t(e) {
            var n;
            d()(this, t),
              (this._singularState = Rn.getInstance().init(e)),
              Cn.isNullOrEmpty(e.customUserId) ||
                this._singularState.setCustomUserId(e.customUserId),
              Tn.info(
                fn()(
                  (n = 'SDK is initialized Apikey:'.concat(
                    e.apikey,
                    ', Product Id:'
                  ))
                ).call(n, e.productId)
              ),
              (this._apiManager = new $n()),
              this.sendApi(new Qn()),
              (this._bannerManager = new rr());
          }
          return (
            g()(t, [
              {
              ...
              },
              {
                ...
                value: function (t, e, n, r) {
                  var i = enrichUrlWithClipboardDdlFlow(
                    this.buildWebToAppLink(t, e, n, r)
                  );
                  i && window.open(i);
                },
              },
              {
                key: 'buildWebToAppLink',
                value: function (t, e, n, r) {
                  var i = Cn.buildWebToAppLink(
                    t,
                    this._singularState.getWebUrl(),
                    e,
                    n,
                    r
                  );
                  return (
                    i ||
                      Tn.warn(
                        'Invalid base link when generating web to app link'
                      ),
                    i
                  );
                },
              ...
              },
              {
                ...
                value: function (t) {
                  var e = lr(),
                    ...
                    s = new qn.a(t);
                  return (
                    s.searchParams.append(a.ECID, o),
              ...
              },
              {
                ...
                value: function (t) {
                  if (
                    !this._singularState._isWebUrlContainingMarketingData(
                      window.location.href
                    )
                  )
                    return t;
                  var e = Cn.parseQueryFromUrl(window.location.href),
                    n = Cn.parseQueryFromUrl(t),
                    r = L()(e),
                    i = L()(n),
                    o = T()(r).call(r, function (t) {
                      return -1 == Sn()(i).call(i, t);
                    }),
                    s = Cn.extractMarketingData(o),
                    a = !0,
                    u = !1,
                    c = void 0;
                  try {
                    for (
                      var f, l = xn()(Vn()(s).call(s));
                      !(a = (f = l.next()).done);
                      a = !0
                    ) {
                      var p,
                        ...
                        v = (d[0], d[1]),
                        g = fn()(
                          (p = ''.concat(encodeURIComponent(v), '='))
                        ).call(p, encodeURIComponent(e[v]));
                      t =
                        -1 != Sn()(t).call(t, '?')
                          ? Cn.appendQueryParamsToUrl('?', g, t)
                          : -1 != Sn()(t).call(t, '#')
                          ? Cn.appendQueryParamsToUrl('#', g, t)
                          : fn()((h = ''.concat(t, '?'))).call(h, g);
                    }
                  } catch (t) {
                    (u = !0), (c = t);
                  } finally {
            ...
            g()(t, null, [
              {
                ...
                value: function (t) {
                  ...
                  this._singularInstance.isSameApp(t)
                    ? this._singularInstance.updateSingularConfig(t)
                    : ((this._singularInstance = new pr(t)),
                      (this._isInitialized = !0),
                      t._initFinished(new hr(this.getSingularDeviceId())));
                },
              },
              {
                key: 'pageVisit',
              ...
              },
              {
                ...
                value: function (t, e, n, r) {
                  if (this._isInitialized) {
                    var i = new Nn(t).withRevenue(e, n).withArgs(r);
              ...
              },
              {
                ...
                value: function (t) {
                  this._isInitialized &&
                    !Cn.isNullOrEmpty(t) &&
                    this._singularInstance.setCustomUserId(t);
                },
              },
              {
                key: 'logout',
              ...
              },
              {
                ...
                value: function (t) {
                  if (this._isInitialized && !Cn.isNullOrEmpty(t)) {
                    this.login(t);
                    var e = new Jn();
                  ...
                  var e =
                    ...
                    r =
                      arguments.length > 3 && void 0 !== arguments[3]
                        ...
                        : null;
                  this._isInitialized &&
                    this._singularInstance.openApp(t, e, n, r);
                },
              },
              {
                key: 'openAppWithClipboardDdl',
                  ...
                  var e =
                    ...
                    r =
                      arguments.length > 3 && void 0 !== arguments[3]
                        ...
                        : null;
                  this._isInitialized &&
                    this._singularInstance.openAppWithClipboardDdl(t, e, n, r);
                },
              },
              {
                key: 'buildWebToAppLink',
                value: function (t) {
                  ...
                  return this._isInitialized
                    ? this._singularInstance.buildWebToAppLink(t, e, n, r)
                    : null;
                },
              },
              {
                ...
                value: function () {
                  return this._isInitialized
                    ? this._singularInstance.getSingularDeviceId()
                    : null;
                },
              },
              {
                key: 'enrichUrlWithMarketingData',
                value: function (t) {
                  return this._isInitialized && Cn.isValidUrl(t)
                    ? this._singularInstance.enrichUrlWithMarketingData(t)
                    : t;
                },
              },
              {
                ...
                value: function (t) {
                  if (this._isInitialized) {
                    if (Rn.getInstance().getSingularConfig().isBannersSupported)
                      return (
                        !t || t instanceof dr || (t = null),
                        this._singularInstance.showBanner(t)
                      );
                    Tn.warn(
                      'cannot show banner, banners feature is not enabled'
                    );
                  }
                },
              },
              {
                ...
                value: function () {
                  if (this._isInitialized) {
                    ...
                    Tn.warn(
                      'cannot hide banner, banners feature is not enabled'
                    );
                  }
                },
              },
              {
                ...
                value: function (t) {
                  return this._isInitialized && Cn.isValidUrl(t)
                    ? this._singularInstance.enrichUrlWithClipboardDdlFlow(t)
                    : t;
                },
              },
            ]),
      ...
      m()(vr, '_isInitialized', !1), m()(vr, '_singularInstance', void 0);
      var gr = (function () {
          function t() {
          ...
          return (
            g()(t, [
              ...
              },
              {
                ...
                value: function (t) {
                  return Cn.setSdkWrapper(t), this;
                },
              },
              {
              ...
              },
              {
                ...
                value: function (t) {
                  return Cn.isNullOrEmpty(t)
                    ? (Tn.debug(
                        'Persistent Singular Device Id provided was empty'
                      ),
                      this)
                    : ((this._singularDeviceId = t), this);
                },
              },
              {
                ...
                value: function (t) {
                  return (
                    Cn.isNullOrEmpty(t) || (this._autoPersistDomain = t), this
                  );
                },
              },
              {
                ...
                value: function (t) {
                  return (
                    (this._bannersSupport = !0),
                    t && t instanceof gr && (this._bannersOptions = t),
                    this
                  );
                },
              },
        ...
        xr = gr;
      window.singularSdk
        ? ((yr = window.singularSdk), (mr = window.SingularConfig))
        : ((window.singularSdk = yr), (window.SingularConfig = mr));
      var br = yr,
        Sr = mr,
        wr = _r,
        kr = xr;
